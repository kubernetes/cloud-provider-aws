...
func TestCloud_buildTargetGroupAttributes(t *testing.T) {
	tests := []struct {
		...
		{
			name: "annotation parsing - malformed annotation should return error",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
				Protocol:       elbv2types.ProtocolEnumHttp,
				TargetType:     elbv2types.TargetTypeEnumInstance,
			...
			annotations: map[string]string{
				ServiceAnnotationLoadBalancerTargetGroupAttributes: "invalid_format_no_equals",
			},
			expectedError: "invalid attribute format",
		},
		{
			name: "annotation parsing - duplicate attribute in annotation should return error",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
				Protocol:       elbv2types.ProtocolEnumHttp,
				TargetType:     elbv2types.TargetTypeEnumInstance,
			...
			annotations: map[string]string{
				ServiceAnnotationLoadBalancerTargetGroupAttributes: "preserve_client_ip.enabled=false,preserve_client_ip.enabled=true",
			},
			expectedError: "is set twice in the annotation",
		},
		{
			name: "annotation parsing - unsupported attribute should return error",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
				Protocol:       elbv2types.ProtocolEnumHttp,
				TargetType:     elbv2types.TargetTypeEnumInstance,
			...
			expectedError: "the attribute \"unsupported_attribute\" is not supported by the controller",
		},
		{
		...
		{
			name: "invalid preserve_client_ip value should return error",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
				Protocol:       elbv2types.ProtocolEnumHttp,
				TargetType:     elbv2types.TargetTypeEnumInstance,
			...
			annotations: map[string]string{
				ServiceAnnotationLoadBalancerTargetGroupAttributes: "preserve_client_ip.enabled=invalid_value",
			},
			expectedError: "invalid attribute value for \"preserve_client_ip.enabled\"",
		},
		{
			name: "invalid preserve_client_ip.enabled=false for UDP target (should fail)",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
			...
			expectedError: "client IP preservation can't be disabled for UDP",
		},
		{
			name: "disable preserve_client_ip for TCP_UDP should return error",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
				Protocol:       elbv2types.ProtocolEnumTcpUdp,
				TargetType:     elbv2types.TargetTypeEnumInstance,
			},
			existingAttributes: []elbv2types.TargetGroupAttribute{
				{Key: aws.String("preserve_client_ip.enabled"), Value: aws.String("true")},
		...
		{
			name: "restore defaults for IP+TCP target group",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
				Protocol:       elbv2types.ProtocolEnumTcp,
				TargetType:     elbv2types.TargetTypeEnumIp,
			...
			existingAttributes: []elbv2types.TargetGroupAttribute{
				{Key: aws.String("preserve_client_ip.enabled"), Value: aws.String("true")}, // Should be false for IP+TCP
				{Key: aws.String("proxy_protocol_v2.enabled"), Value: aws.String("false")},
			},
			annotations: map[string]string{},
			expectedAttributes: []elbv2types.TargetGroupAttribute{
		...
		{
			name: "restore defaults for IP+TLS target group",
			targetGroup: &elbv2types.TargetGroup{
				TargetGroupArn: aws.String("arn:aws:elasticloadbalancing:us-east-1:123456789012:targetgroup/test-tg/1234567890123456"),
			...
			existingAttributes: []elbv2types.TargetGroupAttribute{
				{Key: aws.String("preserve_client_ip.enabled"), Value: aws.String("true")}, // Should be false for IP+TLS
				{Key: aws.String("proxy_protocol_v2.enabled"), Value: aws.String("false")},
			},
			annotations: map[string]string{},
			expectedAttributes: []elbv2types.TargetGroupAttribute{
...
func TestCloud_ensureTargetGroupAttributes(t *testing.T) {
	...
	tests := []struct {
		...
		// buildTargetGroupAttributes failure (malformed annotation)
		{
			name:        "buildTargetGroupAttributes fails with malformed annotation",
			targetGroup: testTargetGroup,
			annotations: map[string]string{ServiceAnnotationLoadBalancerTargetGroupAttributes: "malformed_attribute_without_equals"},
			mockDescribeTargetGroupAttribs: func(ctx context.Context, input *elbv2.DescribeTargetGroupAttributesInput, optFns ...func(*elbv2.Options)) (*elbv2.DescribeTargetGroupAttributesOutput, error) {
			...
			expectedError: "unable to build target group attributes",
			description:   "Function should handle buildTargetGroupAttributes failures",
		},
