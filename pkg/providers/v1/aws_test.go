...
func TestEnsureNLBSecurityGroup(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			annotations:   map[string]string{ServiceAnnotationLoadBalancerSecurityGroups: "sg-123456789"},
			expectedError: "BYO security group annotation \"service.beta.kubernetes.io/aws-load-balancer-security-groups\" is not supported for NLB",
		},
		{
			name:          "multiple BYO SGs - error (not supported)",
			annotations:   map[string]string{ServiceAnnotationLoadBalancerSecurityGroups: "sg-123456789,sg-987654321"},
			expectedError: "BYO security group annotation \"service.beta.kubernetes.io/aws-load-balancer-security-groups\" is not supported for NLB",
		},
		{
			name:          "invalid BYO SG format - error (not supported)",
			annotations:   map[string]string{ServiceAnnotationLoadBalancerSecurityGroups: "invalid-sg-format"},
			expectedError: "BYO security group annotation \"service.beta.kubernetes.io/aws-load-balancer-security-groups\" is not supported for NLB",
		},
		{
