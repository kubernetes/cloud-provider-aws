...
func TestGetVolumeLabels(t *testing.T) {
	...
	awsServices.ec2.(*MockedFakeEC2).On("DescribeVolumes", expectedVolumeRequest).Return([]ec2types.Volume{
		{
...
func TestGetLabelsForVolume(t *testing.T) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			awsServices := newMockedFakeAWSServices(TestClusterID)
			expectedVolumeRequest := &ec2.DescribeVolumesInput{VolumeIds: []string{aws.ToString(test.expectedVolumeID)}}
...
func TestCreateDisk(t *testing.T) {
	...
	awsServices.ec2.(*MockedFakeEC2).On("CreateVolume", request).Return(&ec2.CreateVolumeOutput{
		AvailabilityZone: aws.String("us-west-2a"),
		VolumeId:         aws.String("vol-volumeId0"),
		State:            ec2types.VolumeStateAvailable,
	}, nil)
	...
	awsServices.ec2.(*MockedFakeEC2).On("DescribeVolumes", describeVolumesRequest).Return([]ec2types.Volume{volume}, nil)
