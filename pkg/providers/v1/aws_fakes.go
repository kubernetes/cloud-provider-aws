...
func (s *FakeAWSServices) Autoscaling(ctx context.Context, region string, assumeRoleProvider *stscredsv2.AssumeRoleProvider) (ASG, error) {
	return s.asg, nil
}
...
func (ec2i *FakeEC2Impl) AttachVolume(ctx context.Context, request *ec2.AttachVolumeInput, optFns ...func(*ec2.Options)) (*ec2.AttachVolumeOutput, error) {
	panic("Not implemented")
}
...
func (ec2i *FakeEC2Impl) DeleteVolume(ctx context.Context, request *ec2.DeleteVolumeInput, optFns ...func(*ec2.Options)) (*ec2.DeleteVolumeOutput, error) {
	panic("Not implemented")
}
