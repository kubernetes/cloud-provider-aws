...
KUBERNETES_VERSION="${KUBERNETES_VERSION:-v1.23.17}"
...
if [[ "${UP}" = "yes" ]]; then
    kubetest2 kops \
      ...
      --kops-version-marker=https://console.cloud.google.com/storage/browser/_details/kops-ci/markers/release-1.28/latest-ci-updown-green.txt \
